                ...
                <form id="frmsetor" action="<?php echo site_url('setor/listar/'); ?>" class="horizontal-form" method="GET">
                    <div class="form-body pal">
                        ...
                        <div class="row" id="divBarra" style="display: none;">
                            <div class="col-lg-12 mtm">
                                <h5> <?php echo __("Importação de Setor"); ?></h5>
						...
						<div class="table-responsive">
							<table id="setor_tabela" class="table table-hover table-bordered table-advanced display">
								...
								<tr>
									...
									<th style="width: 20%;"><?php echo __("Idsetor"); ?></th>
									<th style="width: 20%;"><?php echo __("Setor"); ?></th>
...
<script>
    function confirmar(obj)
    {
        ...
        confirm("<?php echo __("Tem certeza que deseja deletar definitivamente o setor?<br /><b>Atenção: Ao confirmar não será possível desfazer essa ação.</b>"); ?>", "<?php echo __("Confirme"); ?>", function(confirmed) {
            if (confirmed)
            {
                window.location = url;
            }
    ...
    function EnviarExcel(){
        ...
        if(Vazio(property))
        {
            alert("<?php echo __("Você deve selecionar o arquivo com os dados de importação de Setors");?>");
            return;
        }
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.sucesso)
                {
                    ...
                    msn = "<?php echo __("Arquivo foi enviado com sucesso.<br/>Aguarde a finalização do processo de importação de Setor.");?>";
                    MsnSucesso(titulo, msn);
