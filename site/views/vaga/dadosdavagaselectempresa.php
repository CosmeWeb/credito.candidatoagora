<section class="container">
    ...
    <div class="telaestrutura">
                ...
                <form id="frmvaga" action="<?php echo site_url('vaga/dadosdavaga') ?>" method="POST">
                    ...
                    <div id="dadosform" class="corpoconteudo">
                        <div class="texto">
                            ...
                            <h4 class="mb-20">
                                Selecione empresas que os profissionais ideais já trabalharam.<br/>
                                Você pode digitar o nome das empresas ou selecioná-las de uma lista de empresas dentro dos setores definidos.
                                <div class="info">
                                    <i class="fa fa-info-circle"></i>
                                    <span>
                                        Você deve digitar o nome da empresa que o sistema irá te apresentar uma lista de empresa, clique em uma empresa para adicioná-la a lista.
                                        <ins></ins>
                                    </span>
                                </div>
                            </h4>
                            <div class="caixa full" style="display: none; margin-bottom: 0px;">
                                <div id="contenerempresas" class="lista incluir">
                                </div>
                            </div>
                            <div id="listaidempresa" class="caixa full">
                                <select id="empresatarget" name="empresatarget">
                                </select>
                                <samp class="OU">OU</samp>
                                <button type="button" id="btn-proup-lista" onclick="ShowLista()"><i class="fa fa-list-alt"></i> Visualizar lista de empresas</button>
                            </div>
                            <h2 class="mb-40">Outras empresas não identificadas</h2>
                            <ol>
                                <li class="titulo">
                                    Considerar outras empresas fora das opções acima selecionadas, mas do mesmo setor identificado como target?
                                </li>
                                <li class="sim">
                                    <input id="incluirempresasforatargetsim" name="incluirempresasforatarget" type="radio" value="Sim" <?php echo $obj->FormGetRadio("incluirempresasforatarget","Sim"); ?>>
                                    <span>Sim</span>
                                </li>
                                <li class="indiferente">
                                    <input id="incluirempresasforatargetnao" name="incluirempresasforatarget" type="radio" value="Não" <?php echo $obj->FormGetRadio("incluirempresasforatarget","Não"); ?>>
                                    <span>Não</span>
                                </li>
                            </ol>
                            <div id="listaempresa" class="caixa full" style="display: none;">
                                <label for="nomeempresa">Digite o nome das empresas</label>
                                <div class="info">
                                    <i class="fa fa-info-circle"></i>
                                    <span>
                                        Digite o nome da empresa e clique em adicionar para incluir a empresa na lista de empresas.
                                        <ins></ins>
                                    </span>
                                </div>
                                <div class="lista" id="areaempresa" style="display: none;">
                                </div>
                                <input class="add" id="nomeempresa" name="nomeempresa" type="text" value="">
                                <button class="add" type="button" onclick="AdicionarEmpresaCorrelata()" title="Adicionar cargo"><i class="fa fa-plus-circle"></i> <span>Adicionar</span> </button>
                            </div>
                            <ol>
                                <li class="titulo">
                                    Excluir candidatos que já tenham trabalhado na empresa contratante?
                                </li>
                                <li class="sim">
        ...
        <div class="textoAjuda cardEstrutura">
            <h2>Quais empresas o candidato deve ter trabalhado?</h2>
            <p>Você optou por selecionar você mesmo as empresas target.</p>
            <p><b>Dica:</b> selecione através da opção drop-down ou pela  lista de empresas que você consegue ver todas as empresas existentes nos seus setores target.</p>
