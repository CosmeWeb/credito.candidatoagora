...
class Gestao {
	...
	{
		$versao = self::$_Versao;
		return array("assets/css/bootstrap.min.css?versao={$versao}");
	}
	######################################################################################################
	public static function jsPadrao()
	{
		$versao = self::$_Versao;
		return array("assets/js/vendor/jquery-1.12.4.min.js?versao={$versao}"
		,"assets/js/bootstrap.min.js?versao={$versao}");
	}
	######################################################################################################
	public static function cssSite()
	{
		$versao = self::$_Versao;
		return array("assets/css/owl.carousel.min.css?versao={$versao}"
		,"assets/css/magnific-popup.css?versao={$versao}"
		,"assets/css/themify-icons.css?versao={$versao}"
		,"assets/css/nice-select.css?versao={$versao}"
		,"assets/css/flaticon.css?versao={$versao}"
		,"assets/css/gijgo.css?versao={$versao}"
		,"assets/css/animate.min.css?versao={$versao}"
		,"assets/css/slick.css?versao={$versao}"
		,"assets/css/slicknav.css?versao={$versao}"
		,"assets/css/style.css?versao={$versao}"
		,"assets/css/responsive.css?versao={$versao}");
	}
	######################################################################################################
	public static function jsSite()
	{
		$versao = self::$_Versao;
		return array("assets/js/vendor/modernizr-3.5.0.min.js?versao={$versao}"
		,"assets/js/popper.min.js?versao={$versao}"
		,"assets/js/owl.carousel.min.js?versao={$versao}"
		,"assets/js/isotope.pkgd.min.js?versao={$versao}"
		,"assets/js/ajax-form.js?versao={$versao}"
		,"assets/js/waypoints.min.js?versao={$versao}"
		,"assets/js/jquery.counterup.min.js?versao={$versao}"
		,"assets/js/imagesloaded.pkgd.min.js?versao={$versao}"
		,"assets/js/scrollIt.js?versao={$versao}"
		,"assets/js/jquery.scrollUp.min.js?versao={$versao}"
		,"assets/js/wow.min.js?versao={$versao}"
		,"assets/js/nice-select.min.js?versao={$versao}"
		,"assets/js/jquery.slicknav.min.js?versao={$versao}"
		,"assets/js/jquery.magnific-popup.min.js?versao={$versao}"
		,"assets/js/plugins.js?versao={$versao}"
		,"assets/js/gijgo.min.js?versao={$versao}"
		,"assets/js/contact.js?versao={$versao}"
		,"assets/js/jquery.ajaxchimp.min.js?versao={$versao}"
		,"assets/js/jquery.form.js?versao={$versao}"
		,"assets/js/jquery.validate.min.js?versao={$versao}"
		,"assets/js/mail-script.js?versao={$versao}"
		,"assets/js/main.js?versao={$versao}");
	}	
	######################################################################################################
	public static function cssSistema()
	{
		$versao = self::$_Versao;
		return array(
		"painel/vendors/jquery-ui-1.11.4.custom/jquery-ui.min.css?versao={$versao}"
		,"painel/vendors/bootstrap/css/bootstrap.min.css?versao={$versao}"
		,"painel/vendors/fonte/elusive-icons-2.0.0/css/elusive-icons.min.css?versao={$versao}"
		,"painel/vendors/fonte/ionic/css/ionic.css?versao={$versao}"		
		,"painel/assets/js/lobibox/css/lobibox.css?versao={$versao}"
		,"painel/vendors/select2/css/select2.min.css?versao={$versao}"
		,"painel/vendors/jquery-toastr/toastr.min.css?versao={$versao}"
		,"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.0/css/all.min.css?versao={$versao}"
		,"assets/css/sistema.css?versao={$versao}");
	}
	######################################################################################################
	public static function jsSistema()
	{
		$versao = self::$_Versao;
		return array(
		"painel/vendors/jquery-ui-1.11.4.custom/jquery-ui.min.js?versao={$versao}",
		"painel/vendors/bootstrap/js/bootstrap.min.js?versao={$versao}",
		"painel/vendors/metisMenu/jquery.metisMenu.js?versao={$versao}",		
		"painel/vendors/jquery-cookie/jquery.cookie.js?versao={$versao}",
		"painel/vendors/jquery-mask/jquery.mask.min.js?versao={$versao}",
		"painel/assets/js/lobibox/js/lobibox.js?versao={$versao}",
		"painel/assets/js/lobibox/js/messageboxes.js?versao={$versao}",
		"painel/assets/js/lobibox/js/notifications.js?versao={$versao}",
		"painel/vendors/select2/js/select2.min.js?versao={$versao}",
		"painel/vendors/jquery-toastr/toastr.min.js?versao={$versao}",
		"https://s3-us-west-2.amazonaws.com/s.cdpn.io/t-1188/splitting-1.0.6.min.js?versao={$versao}",
		"assets/js/mainsistema.js?versao={$versao}"
		);
	}
	######################################################################################################
	...
	################################################################################################################
	public function AssetsSistema()
	{
		$lista = $this->cssSistema();
		if(!empty($lista))
		{
			foreach($lista as $item)
				$this->AddCSS($item);
		}
		$lista = $this->jsSistema();
		if(!empty($lista))
		{
			foreach($lista as $item)
				$this->AddJS($item);
	...
	################################################################################################################
	public function GetViewSign( $page, array $data = NULL)
	{
		$this->Start();
		$this->AssetsSistema();
		$data['page'] = $page;
		$this->CI->load->view( 'layout/layoutsign', $data );
	}
	################################################################################################################
	public function GetViewSite( $page, array $data = NULL)
	{
		$this->Start();
		$this->AssetsSite();
		$data['page'] = $page;
		$data['notificacoes'] = true;
		$this->CI->load->view( 'layout/layoutsite', $data );
	}
	################################################################################################################
