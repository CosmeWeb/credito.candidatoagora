                ...
                <form id="frmfaturamento" action="<?php echo site_url('faturamento/listar/'); ?>" class="horizontal-form" method="GET">
                    <div class="form-body pal">
                        ...
                        <div class="row" id="divBarra" style="display: none;">
                            <div class="col-lg-12 mtm">
                                <h5> <?php echo __("Importação de Faturamento"); ?></h5>
...
<script>
    function confirmar(obj)
    {
        ...
        let msn = "<?php echo __("Tem certeza que deseja deletar definitivamente o faturamento?<br /><b>Atenção: Ao confirmar não será possível desfazer essa ação.</b>"); ?>";
    ...
    function ExportarFaturamento(file = "", posicao = 0, total = 0)
    {
        ...
        $.ajax({
            ...
            error: function(XHR, textStatus, errorThrown){
                let msn = "<?php echo __("Falha na de verificação de faturamento");?>";
                $('#divloding').slideUp("slow");
                $('#divBarra').slideUp("slow");
                alert(msn);
            }
    ...
    function EnviarExcel(){
        ...
        if(Vazio(property))
        {
            alert("<?php echo __("Você deve selecionar o arquivo com os dados de importação de Faturamentos");?>");
            return;
        }
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.sucesso)
                {
                    ...
                    msn = "<?php echo __("Arquivo foi enviado com sucesso.<br/>Aguarde a finalização do processo de importação de Faturamento.");?>";
                    MsnSucesso(titulo, msn);
