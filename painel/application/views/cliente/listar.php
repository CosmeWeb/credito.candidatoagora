                ...
                <form id="frmcliente" action="<?php echo site_url('cliente/listar/'); ?>" class="horizontal-form" method="GET">
                    <div class="form-body pal">
                        ...
                        <div class="row" id="divBarra" style="display: none;">
                            <div class="col-lg-12 mtm">
                                <h5> <?php echo __("Importação de Cliente"); ?></h5>
							...
							<table id="cliente_tabela" class="table table-hover table-bordered table-advanced display">
								<thead>
                                    <tr>
                                        ...
                                        <th style="width: 8%;"><?php echo __("Créditos"); ?></th>
...
<script>
    ...
    function confirmar(obj)
    {
        ...
        confirm("<?php echo __("Tem certeza que deseja deletar definitivamente o cliente?<br /><b>Atenção: Ao confirmar não será possível desfazer essa ação.</b>"); ?>", "<?php echo __("Confirme"); ?>", function(confirmed) {
            if (confirmed)
            {
                window.location = url;
            }
    ...
    function EnviarExcel(){
        ...
        if(Vazio(property))
        {
            alert("<?php echo __("Você deve selecionar o arquivo com os dados de importação de Clientes");?>");
            return;
        }
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.sucesso)
                {
                    ...
                    msn = "<?php echo __("Arquivo foi enviado com sucesso.<br/>Aguarde a finalização do processo de importação de Cliente.");?>";
                    MsnSucesso(titulo, msn);
    ...
    {
        let msn = "<?php echo __("Tem certeza que deseja alterar senha do cliente?<br /><b>Atenção: Você deve salvar a nova senha para enviá-la ao cliente.</b>"); ?>";
